...
<div style="" class="navi">
<ul>
<li class="active"><a href="content_data.php"><i class="fa fa-tasks-sm" aria-hidden="true"></i><span class="hidden-xs hidden-sm">News</span></a></li>
<li><a href="user_data.php"><i class="fa fa-user-sm" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Users</span></a></li>
</div>
</div>
